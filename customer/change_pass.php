...
<tr>
<td><b>Enter Current Password:</b><br></td>
<td><input type="password" name="current_pass" required></td>
</tr>
<tr>
<td><b>Enter New Password:</b><br></td>
<td><input type="password" name="new_pass" required></td>
</tr>
<tr>
<td><b>Enter New Password Again:</b><br></td>
...
if(isset($_POST['change_pass'])){
	...
	if($check_pass==0){
		echo "<script>alert('You current Password is wrong!')</script>";
		exit();
	}
