...
$row_pro=mysqli_fetch_array($run_pro);
  ...
  $category_title = $row_cat['cat_title'];     /*category show*/
  ...
  $brand_title = $row_brand['brand_title'];     /*brand show*/
...
<table width="795" align="center" border="2" bgcolor="orange"  border-collapse="collapse">
   ...
   <td colspan="8"><h2><u><b>Edit & Update Product</b></u></h2></td>
...
<?php
  ...
  while ($row_brands=mysqli_fetch_array($run_brands)){
   ...
   <td align="right"><b>Product Image: </b></td>
    <td><input type="file" name="product_img" /><img src="product_img/<?php echo $pro_image; ?>" width="60" height="60"/></td>
	</tr>
...
<?php
  ...
  $update_product = "update products set product_cat='$product_cat',product_brand='$product_brand',product_title='$product_title',product_desc='$product_desc',product_img='$product_img',product_keywords='$product_keywords' where product_id ='$update_id'";
